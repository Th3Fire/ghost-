...
string CLanguage :: UserStartVoteEnd( string name )
{
	string Out = m_CFG->GetString( "lang_0221", "lang_0221" );
	UTIL_Replace( Out, "$NAME$", name );
	return Out;
}
string CLanguage :: WarningPlayerAFK( string name )
{
	string Out = m_CFG->GetString( "lang_0222", "lang_0222" );
	UTIL_Replace( Out, "$NAME$", name );
	return Out;
}
string CLanguage :: TimeCountDownLimitLobby( string mins, string secs )
{
	string Out = m_CFG->GetString( "lang_0223", "lang_0223" );
	UTIL_Replace( Out, "$MINS$", mins );
